...
class WPSO_Admin_Init {
    ...
    public static function enqueue_admin_assets($hook) {
        ...
        wp_localize_script('wpso-admin-js', 'wpsoAdmin', [
    ...
    public static function render_dashboard_page() {
        include WPSO_DIR_PATH . 'includes/admin/wpso-admin-dashboard.php';
    }

    public static function render_settings_page() {
        include WPSO_DIR_PATH . 'includes/admin/wpso-admin-settings.php';
    }

    public static function render_tools_page() {
        include WPSO_DIR_PATH . 'includes/admin/wpso-admin-tools.php';
    }
}
